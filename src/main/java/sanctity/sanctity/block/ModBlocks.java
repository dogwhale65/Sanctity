package sanctity.sanctity.block;
...
public class ModBlocks {
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK, new Identifier(Sanctity.MOD_ID, name), block);
    }
    private static Item registerBlockItem(String name, Block block) {
        return Registry.register(Registries.ITEM, new Identifier(Sanctity.MOD_ID, name),
                new BlockItem(block, new FabricItemSettings()));
    }
    public static void registerModBlocks() {
        Sanctity.LOGGER.info("Registering ModBlocks for " + Sanctity.MOD_ID);
    }
}
